      ...
      <div className="container py-8">
        ...
        {activeTab === "manage" && (
          <div className="space-y-8">
            <Card>
              <CardHeader><CardTitle className="font-display">Manage Categories</CardTitle></CardHeader>
              <CardContent>
                    ...
                    <tbody>
                      {allCategories.map((cat: any) => (
                        <tr key={cat.id} className="border-b border-border/50">
                          <td className="py-3">
                            {cat.image_url ? <img src={cat.image_url} alt={cat.name} className="h-10 w-10 rounded-lg object-cover" /> : <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-muted text-xs text-muted-foreground">—</div>}
                          </td>
                          <td className="py-3 font-medium text-foreground">{cat.name}</td>
                          <td className="py-3 text-muted-foreground">{cat.description || "—"}</td>
                          <td className="py-3">
                            <Button size="sm" variant="outline" onClick={() => setEditCategory(cat)}><Pencil className="h-3.5 w-3.5 mr-1" /> Edit</Button>
                          </td>
                        </tr>
                      ))}
                    </tbody>
            ...
            <Card>
              <CardHeader><CardTitle className="font-display">Manage Products</CardTitle></CardHeader>
              <CardContent>
                <div className="overflow-x-auto">
                  <table className="w-full text-sm">
                    <thead>
                    ...
                    <tbody>
                      {allProducts.map((p: any) => (
                        <tr key={p.id} className="border-b border-border/50">
                          <td className="py-3">
                            {p.image_url ? <img src={p.image_url} alt={p.name} className="h-10 w-10 rounded-lg object-cover" /> : <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-muted text-xs text-muted-foreground">—</div>}
                          </td>
                          ...
                          <td className="py-3">
                            <Button size="sm" variant="outline" onClick={() => setEditProduct(p)}><Pencil className="h-3.5 w-3.5 mr-1" /> Edit</Button>
                          </td>
                        </tr>
                      ))}
                    </tbody>
